...
SECRET_KEY = 'django-insecure-*s-v5h5i6k52l%$dt3*fn8c6opiaro!)k#kg0$weclbygjs9z*'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/Users/Seidor/Documents/CODER-HOUSE/MiUniversidad/Modulos/Academica/Plantillas'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
